...
export default function ApplicationsPage({ slug }: ApplicationsPageProps) {
  ...
  const loadData = async () => {
    try {
      ...
      const result = await fetchSiteData(currentSlug, '/applications')
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-lg mb-8">
            Thank you for your interest in adopting from {organization.name}. We'll review your application and get back to you within 2-3 business days.
          </p>
    ...
    <div className="min-h-screen" style={{ backgroundColor: siteData?.design?.background_color || '#FFFFFF' }}>
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Thank you for your interest in adopting from {organization.name}. Please fill out this application completely and honestly.
        </p>
      </div>
