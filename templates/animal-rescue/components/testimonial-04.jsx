      ...
      <div className="container">
        <div className="mx-auto w-full max-w-lg text-center">
          ...
          <blockquote className="text-xl font-bold md:text-2xl">
            "Donating to this shelter has been one of the most rewarding
            experiences of my life. I’ve seen firsthand how my contributions
            help save lives and bring joy to families."
          </blockquote>
