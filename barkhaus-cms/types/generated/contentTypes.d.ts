...
export interface ApiOrganizationOrganization
  ...
  attributes: {
    ...
    bodyFont: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Inter'>;
    contactInfo: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    headingFont: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Inter'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['header', 'hero', 'about', 'services', 'gallery', 'footer', 'custom']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
